...
- `scenes/battle/m17n2_test.tscn` — M17n-2 weather/evasion + speed family, plus Air Lock: Swift Swim/Chlorophyll/Sand Rush speed-doubling with discriminators and the Utility Umbrella nuance (blocks Swift Swim/Chlorophyll, not Sand Rush), Sand Veil/Snow Cloak's accuracy reduction, full-battle Swift Swim changing turn order, the key cross-ability test (Air Lock negates Swift Swim's speed boost, restoring normal turn order), full-battle confirmation Air Lock negates both the weather damage multiplier and end-of-turn chip damage, Sand Spit setting Sandstorm on being hit (plus a no-duplicate-signal negative case), Mold Breaker bypass and Neutralizing Gas suppression, and a negative control (41 tests)
